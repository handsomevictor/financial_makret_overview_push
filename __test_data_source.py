...
# def us_common_tickers(platform_name):
...
#     else:
#         file_name = os.path.join(os.getcwd(), 'temp_database_for_convenience', 'us_common_tickers.pkl')
#     try:
#         # 查看文件创建时间
...
#         print('Common tickers file expired or does not exists, uncommon tickers processed data redownloading!')
#         US_get_processed_data(which_market='us', only_for_common_tickers=False, auto_save=True)
#
